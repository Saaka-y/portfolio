  ...
  return (
    <Html lang="en">
      <Head>
        ...
        <link href="https://fonts.googleapis.com/css2?family=Cabin+Sketch:wght@400;700&family=Darumadrop+One&family=Patrick+Hand+SC&family=Yomogi&display=swap" rel="stylesheet" />
      </Head>
      <body>
        <Main />
        <NextScript />
